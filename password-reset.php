        ...
        <div class="col col-xl-6">
            <div class="card" style="border-radius: 1rem;">
                ...
                <?php include('message.php'); ?>
                    ...
                    <form method="POST" action="password-reset-code.php" class="align-items-center text-start" >
                        ...
                        <div class="pt-1 mb-4">
                            <button class="btn btn-dark btn-lg btn-block login" type="submit" name="reset_password_btn"">Send Password Reset Link</button>
                        </div>
